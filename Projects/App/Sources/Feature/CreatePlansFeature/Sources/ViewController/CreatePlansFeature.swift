...
public final class CreatePlansFeature: BaseFeature {
    public let viewModel: CreatePlansViewModel
    ...
    private lazy var contentView = CreatePlansContentView()
...
//        view.isScrollEnabled = false
    ...
    private lazy var doneButton = MYRTextButton("약속 만들기", textColor: .neutral(.balck), font: .subtitle1, backgroundColor: .primary(.primary2), cornerRadius: 16)
    
    public init(viewModel: CreatePlansViewModel) {
    ...
    public override func bindViewModel() {
        let input = CreatePlansViewModel.Input(
        ...
        output.result
            .subscribe(with: self) { owner, _ in
                print("success")
                owner.viewModel.actions?.finishCreatePlansFeature()
...
private extension CreatePlansFeature {
